...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-header__inner">
			...
			<nav id="site-navigation" class="main-navigation" aria-label="<?php esc_attr_e( 'Primary menu', 'demo' ); ?>">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'demo' ); ?></button>
				<?php
				wp_nav_menu(
					array(
			...
			<a class="header-cta" href="<?php echo esc_url( home_url( '/contact' ) ); ?>"><?php esc_html_e( 'Get Started', 'demo' ); ?></a>
		</div>
	</header><!-- #masthead -->
